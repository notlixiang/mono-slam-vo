...
public:
  ...
  unordered_map<unsigned long, MapPoint::Ptr>
      matched_map_points_; // all landmarks
  unordered_map<unsigned long, cv::Point2f>
      matched_map_points_position_; // all landmarks
